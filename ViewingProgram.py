...
window = sg.Window("Data Logger Viewer", layout, no_titlebar = False, keep_on_top=True, location=(0, 0), element_justification='c',use_custom_titlebar=True,titlebar_icon=fireIcon,titlebar_font=font).Finalize() #
window.Maximize()
...
# ~~~~~ Compile ~~~~~
#pyinstaller -wF --splash=splashLoad.jpg --icon=ViewerIcon.ico ViewingProgram.py