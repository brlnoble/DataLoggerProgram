...
numList = [19,27,18,25,18,21,35.5,50,75,100,125,150,225,300,350,400,500,600,600,600,550,500,350,200,50,21,25,20,17,21,19,27,18,25,18,21,35.5,50,75,100,125,150,225,300,350,400,500,600,600,600,550,500,350,200,50,21,25,20,17,21]
header = ['Time','Temp1','Temp2','Temp3','Temp4','Temp5','Temp6']
num = uniform(0.7,1.3)
count = 0

with open('9timeTest.csv','w',newline='') as f:
    writer = csv.writer(f)
